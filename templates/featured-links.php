...
<div id="featured-links" class="<?php echo esc_attr(ashe_options( 'general_links_width' )) === 'boxed' ? ' boxed-wrapper': ''; ?> clear-fix">
	...
	<div class="featured-link">
		...
		<a href="<?php echo esc_url( ashe_options( 'featured_links_url_1' ) ); ?>">
			<div class="cv-outer">
				<div class="cv-inner">
					<p><?php echo esc_html( ashe_options( 'featured_links_title_1' ) ); ?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="featured-link">
		...
		<a href="<?php echo esc_url( ashe_options( 'featured_links_url_2' ) ); ?>">
			<div class="cv-outer">
				<div class="cv-inner">
					<p><?php echo esc_html( ashe_options( 'featured_links_title_2' ) ); ?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="featured-link">
		...
		<a href="<?php echo esc_url( ashe_options( 'featured_links_url_3' ) ); ?>">
			<div class="cv-outer">
				<div class="cv-inner">
					<p><?php echo esc_html( ashe_options( 'featured_links_title_3' ) ); ?></p>
				</div>
			</div>
		</a>
	</div>
